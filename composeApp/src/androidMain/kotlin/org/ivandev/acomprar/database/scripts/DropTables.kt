...
object DropTables {
    ...
    val DROP_TABLE_COMIDA: String = "DROP TABLE IF EXISTS ${Literals.Database.COMIDA_TABLE}"
    val DROP_TABLE_COMIDA_PRODUCTO: String = "DROP TABLE IF EXISTS ${Literals.Database.COMIDA_PRODUCTO_TABLE}"
    val DROP_TABLE_MENU: String = "DROP TABLE IF EXISTS ${Literals.Database.MENU_TABLE};"
    val DROP_TABLE_MENU_COMIDA: String = "DROP TABLE IF EXISTS ${Literals.Database.MENU_COMIDA_TABLE};"
